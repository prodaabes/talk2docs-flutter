...
class ChatItemWidget extends StatelessWidget {
  ...
  return showDialog(
    ...
    builder: (BuildContext context) {
      return AlertDialog(
        title: const Text('Edit Chat Name', style: TextStyle(color: Color(0xFF000026))),
        content: Padding(
        ...
        actions: <Widget>[
          TextButton(
            ...
            child: const Text('Cancel', style: TextStyle(color: Color(0xFF000026))),
          ),
          TextButton(
            onPressed: () {
            ...
            child: const Text('Save', style: TextStyle(color: Color(0xFF000026))),
          ),
        ],
      );
    },
